...
if __name__ == "__console__":
    ...
    for ftr_in in lyr_in.getFeatures():
        ...
        fld_poly_idx = lyr_out.fields().indexOf("poly_id")
        fld_x_idx = lyr_out.fields().indexOf("x_coord")
        fld_y_idx = lyr_out.fields().indexOf("y_coord")
        
        ftr_out.setAttribute(fld_poly_idx, ftr_in.id())
    ...
    fn_style = r"C:\Users\lukas\Desktop\SKRYPTY\BBOX&LENGTH\style\sharpest_vertex.qml"
